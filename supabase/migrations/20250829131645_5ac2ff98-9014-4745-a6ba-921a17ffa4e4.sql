-- Atualizar configuração de créditos grátis para 5 SMS
...
VALUES ('free_credits_new_user', '5', 'Número de créditos grátis para novos usuários')
ON CONFLICT (key) DO UPDATE SET 
  value = EXCLUDED.value,
  updated_at = now();

-- Modificar função handle_new_user para usar configuração dinâmica
