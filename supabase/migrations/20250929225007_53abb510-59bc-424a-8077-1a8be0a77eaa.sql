-- Fix critical SMTP settings security vulnerability (corrected version)
...
-- Add trigger for SMTP settings access monitoring (INSERT/UPDATE/DELETE only)
...
-- 5. Drop existing policies and create new comprehensive ones
