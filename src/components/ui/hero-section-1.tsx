                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=3276&h=4095&fit=crop&auto=format"
                                alt="background"
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        <Link to="/quick-send">
                                            <span className="text-nowrap">Demo Gratuita</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
...
const menuItems = [
    ...
    { name: 'Preços', href: '/dashboard' },
    { name: 'SMS Rápido', href: '/quick-send' },
