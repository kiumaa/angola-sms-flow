              ...
              <CardContent className="p-8 h-full flex flex-col">
                <div className="flex flex-col gap-6 flex-grow">
                  <div className="text-center">
                    ...
                    {pkg.description && <p className="text-muted-foreground text-sm leading-relaxed">
                        {pkg.description}
                      </p>}
                  </div>
                  ...
                  <div className="border-t border-border pt-6">
                    <div className="space-y-3">
                      {[`${pkg.credits.toLocaleString()} créditos SMS`, "Dashboard completo", "Suporte técnico", "Relatórios detalhados", "Envio programado", "Gestão de contactos"].map((feature, featureIndex) => <div key={featureIndex} className="flex items-center gap-3">
                ...
                <div className="pt-6 border-t border-border mt-6">
                  <Button onClick={() => handlePurchase(pkg.id)} className={`w-full transition-all duration-300 group ${isPopular ? 'bg-primary text-primary-foreground hover:bg-primary/90 shadow-glow' : 'bg-secondary text-secondary-foreground hover:bg-secondary/80 border border-border'}`} size="lg">
                    Escolher Pacote
